...
impl KeyNode for ChildKeysPrivate {
    fn root(seed: [u8; 64]) -> Self {
        ...
        let vpk = IncomingViewingPublicKey::from_scalar(vsk);
        ...
        Self {
            value: (
                KeyChain {
                    ...
                    incoming_viewing_public_key: vpk,
                    private_key_holder: PrivateKeyHolder {
                        nullifier_secret_key: nsk,
                        incoming_viewing_secret_key: vsk,
                    },
                },
...
mod tests {
    ...
    use super::*;
    use crate::key_management::{self, secret_holders::IncomingViewingSecretKey};
    ...
    fn test_master_key_generation() {
        ...
        let expected_vsk: IncomingViewingSecretKey = [
        ...
        assert!(expected_vsk == keys.value.0.private_key_holder.incoming_viewing_secret_key);
        assert!(expected_vpk_as_bytes == keys.value.0.incoming_viewing_public_key.to_bytes());
    }
    ...
    fn test_child_keys_generation() {
        ...
        assert!(expected_vpk_as_bytes == child_node.value.0.incoming_viewing_public_key.to_bytes());
    }
}
